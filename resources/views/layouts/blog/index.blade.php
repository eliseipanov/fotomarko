    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Blog</h2>
          <ol>
            <li><a href="https://fotomarko.de/{{ App::getLocale() }}/">Home</a></li>
            <li>Blog</li>
          </ol>
        </div>
  ...
  <footer id="footer">
    ...
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">BootstrapMade</a> && Redisigned by <a href="https://buddha.net.ua/">www.buddha.net.ua</a>
      </div>
    </div>
  </footer><!-- End Footer -->

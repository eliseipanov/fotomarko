...
<section id="portfolio" class="portfolio">
    ...
    <div class="container">
      ...
      <div class="row portfolio-container">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-city">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <p>Center</p>
              <div class="portfolio-links">
                <a href="{{asset('assets/img/portfolio')}}/portfolio-city4.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox" title="Osnabrück, Center"><i class="bx bx-plus"></i></a>
                <!--<a href="portfolio-details.html" class="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i class="bx bx-link"></i></a> -->
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-animals">
          <div class="portfolio-wrap">
            <img src="{{asset('assets/img/portfolio')}}/portfolio-animals04.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-subjects">
          <div class="portfolio-wrap">
            <img src="{{asset('assets/img/portfolio')}}/portfolio-subjectsQ.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Subjects</h4>
              <p>Proliski</p>
              <div class="portfolio-links">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-subjects">
          <div class="portfolio-wrap">
            <img src="{{asset('assets/img/portfolio')}}/portfolio-11.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Subjects</h4>
              <p>Mashrooms</p>
              <div class="portfolio-links">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-animals">
          <div class="portfolio-wrap">
            <img src="{{asset('assets/img/portfolio')}}/portfolio-animals02.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>People and Dogs</h4>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-animals">
          <div class="portfolio-wrap">
            <img src="{{asset('assets/img/portfolio')}}/portfolio-animals03.jpg" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>People and Dogs</h4>
              <p>Dogs are Great</p>
              <div class="portfolio-links">
